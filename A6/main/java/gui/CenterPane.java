...
public class CenterPane extends StackPane {
	...
	private CenterPane() {
		...
		background.setStyle("-fx-background-color: lightskyblue;");
		VBox hehe = new VBox();
		Region space = new Region();
		space.setMinHeight(25);
		space.setMaxHeight(25);
		hehe.getChildren().addAll(space, background);
		VBox.setVgrow(background, Priority.ALWAYS);
		this.getChildren().addAll(hehe, bottomLayer, topLayer);
